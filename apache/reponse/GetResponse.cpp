...
void GetResponse::makeResponse(int cfd, Request* req)
{
    ...
    std::string path = "pages" + requestPath;
    ...
    if (path.compare("pages/") == 0) {
        std::cout << "serving index page" << std::endl;
        return sendPage("pages/index.html", cfd, true);
    }
    ...
    // Serve static file
    std::cout << "serving static file: " << path << std::endl;
